...
{
	// Custom Menu Items
	protected static $login_menu_item_urls = array('#uo_log_in_link', '#uo_log_out_link', '#uo_log_in_out_link', '#uo_register_link');
	...
	{
		add_meta_box('uncanny_menu_links', __('Uncanny Menu Links'), array(__CLASS__, 'create_admin_nav_menu_metabox'), 'nav-menus', 'side', 'default');
	}
