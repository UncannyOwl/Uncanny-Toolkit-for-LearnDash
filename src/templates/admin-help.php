...
<table style=" max-width: 750px; width: 100%; text-align: left; font-family: arial; font-size:12px;" cellspacing="0" >
	...
	<tr style="background-color: #f9f9f9;">
		<td style="padding: 3px; margin: 0; text-align: left; width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;"  scope="row"><strong><?php _e( 'PHP Version', 'uncanny-learndash-toolkit' ) ?></strong></td>
	...
	<?php if ( $wpdb->is_mysql == true ) { ?>
		<tr>
			<td style="padding: 3px; margin: 0; text-align: left; width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" ><strong><?php _e( 'MySQL version', 'uncanny-learndash-toolkit' ) ?></strong></td>
...
<table style=" max-width: 750px; width: 100%; text-align: left; font-family: arial; font-size:12px;" cellspacing="0" >
	...
	<tbody>
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'WordPress Version', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr>
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'Is Multisite', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'Site Language', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr>
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'DISABLE_WP_CRON', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'WP_DEBUG', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr>
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'WP_DEBUG_DISPLAY', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'SCRIPT_DEBUG', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'WP_DEBUG_LOG', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr>
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'WP_AUTO_UPDATE_CORE', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'WP_MAX_MEMORY_LIMIT', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr>
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'WP_MEMORY_LIMIT', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'DB_CHARSET', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr>
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'DB_COLLATE', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'Object Cache', 'uncanny-learndash-toolkit' ) ?></strong></th>
...
<table style=" max-width: 750px; width: 100%; text-align: left; font-family: arial; font-size:12px;"cellspacing="0" >
	...
	<?php foreach ( $plugins as $plugin ) { ?>
		<tr <?php if($i%2 === 0){?> style="background-color: #f9f9f9;"<?php } ?>>
			<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php echo $plugin['Title'] ?></strong></th>
...
<table style=" max-width: 750px; width: 100%; text-align: left; font-family: arial; font-size:12px;"cellspacing="0" >
	...
	<tbody>
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'Version', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr>
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'DB Version', 'uncanny-learndash-toolkit' ) ?></strong></th>
	...
	<tr style="background-color: #f9f9f9;">
		<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php _e( 'Script Debug', 'uncanny-learndash-toolkit' ) ?></strong></th>
...
<table style=" max-width: 750px; width: 100%; text-align: left; font-family: arial; font-size:12px;"cellspacing="0" >
	...
	<?php foreach ( $php_ini_settings as $ini_key ) { ?>
		<tr <?php if($i%2 === 0){?> style="background-color: #f9f9f9;"<?php } ?>>
			<th style="width: 50%;text-align: left; border-bottom: 1px solid #000; margin: 0;" scope="row"><strong><?php echo $ini_key ?></strong></th>
...
<form id="contact" name="uncanny-help" method="post" action="<?php echo admin_url( 'admin.php' ) ?>?page=uncanny-learnDash-toolkit-support&tab=submit-a-ticket">
	...
	<fieldset>
		<input type="checkbox" value="yes" name="site-data" checked="checked"> Send Site Data (<a href="#">View
		                                                                                                   Sample</a>)
	</fieldset>
	<fieldset>
