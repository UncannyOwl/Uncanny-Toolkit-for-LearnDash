...
if ( moduleIsActive( 'uncanny_learndash_toolkit\\FrontendLoginPlus' ) ){
    ...
    registerBlockType( 'uncanny-toolkit/login-wordpress', {
        title: __( 'WordPress Login Form' ),

        description: __( 'Displays a default WordPress login form.' ),
